...
COMPONENT_CONSTRUCTORS[:loggammacoxprocess] = (p, params) -> begin
    ...
    LogGammaCoxProcess(inner_model_obj, p.sigma, p.shape)
end
...
function get_updates(
    ...
    return """
        # --- Log-Gaussian Cox Process Model: $(spec.key) ---
        ...
        for t in 1:M.t_N, s in 1:M.s_N
            ...
            log_mu = base_contribution + (spec.hyper.is_spatiotemporal ? Z_st[s, t] : Z_st[s])
